 ...
 */
@NonNullByDefault
public class FittingProbability<Data, ParentType extends ICompositeRandomVariable<Data, ?, ?>&Iterable<? extends IRandomVariableWithProbabilityStrategy<Data, ? ,?>>>
	implements IDynamicProbabilityStrategy, IModifiableProbabilityStrategy, IMergeableProbabilityStrategy
{
	...
	public FittingProbability(final IRandomVariable<Data, ParentType> set, final int probability)
	{
		_set = set;
		_probability = probability;
	}

	public FittingProbability(final IRandomVariable<Data, ParentType> set)
	{

	...
	implements IDynamicProbabilityStrategy, IModifiableProbabilityStrategy, IMergeableProbabilityStrategy
{
	...
	public FittingProbability(final IParentedRandomVariable<Data, ParentType> set, final int probability)
	{
		_set = set;
		_probability = probability;
	}

	public FittingProbability(final IParentedRandomVariable<Data, ParentType> set)
	{

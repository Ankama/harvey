 ...
 */
@NonNullByDefault
public abstract class AbstractOrderedDataWrapperRandomVariable
<
	Data,
...
implements IOrderedRandomVariable<Data>
{
	...
	implements IOrderedInnerTypeDataWrapperRandomVariable<Data, ProbabilityStrategy>
	{
		...
		{
			if(isLowerThan(value))
				return new ReadOnlyOrderedDataWrapperRandomVariable<Data>(AbstractOrderedDataWrapperRandomVariable.this);
			return null;
		}

 ...
 */
@NonNullByDefault
public class GenericFittingCompositeRandomVariable
<
	Data,
...
>
extends EditableCompositeRandomVariable<Data, ParentType, ChildType, Behaviour, FittingProbability<Data, ParentType>>
{
	public GenericFittingCompositeRandomVariable(@Nullable final ParentType parent, final Behaviour behaviour, final int probability) throws OverOneProbabilityException
	{
		super(parent, behaviour, new FittingProbability<Data, ParentType>(probability));
		getProbabilityStrategy().init(this);
	}

	public GenericFittingCompositeRandomVariable(final Behaviour behaviour, final int probability) throws OverOneProbabilityException
	{
		super(behaviour, new FittingProbability<Data, ParentType>(probability));
		getProbabilityStrategy().init(this);
	}

	public GenericFittingCompositeRandomVariable(@Nullable final ParentType parent, final Behaviour behaviour) throws OverOneProbabilityException
	{
		super(parent, behaviour, new FittingProbability<Data, ParentType>());
		getProbabilityStrategy().init(this);
	}

	public GenericFittingCompositeRandomVariable(final Behaviour behaviour) throws OverOneProbabilityException
	{

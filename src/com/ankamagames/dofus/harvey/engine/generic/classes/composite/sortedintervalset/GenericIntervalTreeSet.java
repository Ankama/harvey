 ...
 */
@NonNullByDefault
public class GenericIntervalTreeSet<Interval extends IGenericInterval<E>, E>
implements ISortedGenericIntervalSet<Interval, E>
{
    ...
    public GenericIntervalTreeSet(final @Nullable Comparator<? super E> comparator) {
    ...
    public GenericIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public GenericIntervalTreeSet(final ISortedGenericIntervalSet<Interval, E> s) {
	...
	@Override
	public ISortedGenericIntervalSet<Interval, E> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedGenericIntervalSet<Interval, E> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedGenericIntervalSet<Interval, E> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
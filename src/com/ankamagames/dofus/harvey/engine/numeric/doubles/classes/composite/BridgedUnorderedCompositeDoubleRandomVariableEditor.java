...
import com.ankamagames.dofus.harvey.numeric.doubles.datawrapper.FixedProbabilityDoubleWrapper;
...
>
extends AbstractBridgedCompositeDoubleRandomVariableEditor<IEditableDoubleRandomVariable, BaseEditableDoubleRandomVariableWrapper<?, ?, ?>, ProbabilityStrategies, Bridged>
{
	...
	{
		return getNewChild(new FixedProbabilityDoubleWrapper(value), probability, probabilityStrategy);
	}

	@Override
	protected BaseEditableDoubleRandomVariableWrapper<?, ?, ?> getNewChild(
			final IEditableDoubleRandomVariable randomVariable, final int probability,
			final @Nullable ProbabilityStrategies probabilityStrategy)
	{
		...
		final BaseEditableDoubleRandomVariableWrapper<IEditableDoubleRandomVariable, Bridged, IBridgedEditableProbabilityStrategy<? super BaseDoubleRandomVariableWrapper<?, ?, ?>>> newWrapper =
				new BaseEditableDoubleRandomVariableWrapper<IEditableDoubleRandomVariable, Bridged, IBridgedEditableProbabilityStrategy<? super BaseDoubleRandomVariableWrapper<?, ?, ?>>>(randomVariable, _bridged, newProbabilityStrategy);

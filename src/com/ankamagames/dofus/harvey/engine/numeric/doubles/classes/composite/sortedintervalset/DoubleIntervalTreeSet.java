 ...
 */
@NonNullByDefault
public class DoubleIntervalTreeSet<Interval extends IDoubleInterval>
implements ISortedDoubleIntervalSet<Interval>
{
    ...
    public DoubleIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public DoubleIntervalTreeSet(final ISortedDoubleIntervalSet<Interval> s) {
    	this();
        addAll(s);
    }
	...
	@Override
	public ISortedDoubleIntervalSet<Interval> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedDoubleIntervalSet<Interval> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedDoubleIntervalSet<Interval> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
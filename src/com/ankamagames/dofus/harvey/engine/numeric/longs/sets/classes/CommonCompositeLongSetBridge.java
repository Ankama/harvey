 ...
 */
@NonNullByDefault
public class CommonCompositeLongSetBridge
<
	...
	ChildType extends ICommonLongSet<Bound, Set, SimpleSet, ElementarySet>,
...
extends AbstractSetBridge<Set, SimpleSet, ElementarySet, Bridged>
{
	...
	public CommonCompositeLongSetBridge(final Bridged bridged,
	...
	public List<? extends Set> split(final long[] values, final boolean[] isIntervalStart) {

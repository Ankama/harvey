 ...
 */
@NonNullByDefault
public class LongIntervalTreeSet<Interval extends ILongInterval>
implements ISortedLongIntervalSet<Interval>
{
    ...
    public LongIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public LongIntervalTreeSet(final ISortedLongIntervalSet<Interval> s) {
    	this();
        addAll(s);
    }
	...
	@Override
	public ISortedLongIntervalSet<Interval> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedLongIntervalSet<Interval> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedLongIntervalSet<Interval> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
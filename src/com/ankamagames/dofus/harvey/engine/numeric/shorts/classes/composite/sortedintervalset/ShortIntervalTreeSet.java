 ...
 */
@NonNullByDefault
public class ShortIntervalTreeSet<Interval extends IShortInterval>
implements ISortedShortIntervalSet<Interval>
{
    ...
    public ShortIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public ShortIntervalTreeSet(final ISortedShortIntervalSet<Interval> s) {
    	this();
        addAll(s);
    }
	...
	@Override
	public ISortedShortIntervalSet<Interval> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedShortIntervalSet<Interval> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedShortIntervalSet<Interval> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
 ...
 */
@NonNullByDefault
public interface ICommonShortSet
<
...
ISortedSet<Bound, Set, SimpleSet, ElementarySet>
{
	 ...
	 */
	List<? extends Set> split(@NonNull short[] values, @NonNull boolean[] isIntervalStart);
	List<? extends Set> split(@NonNull short... values);

 ...
 */
@NonNullByDefault
public class ContinuousByteBoundComparisonToolbox
<
	Set extends IIContinuousByteSet<Set, SimpleSet, ElementarySet>,
	...
	Bridged extends IIContinuousByteSet<Set, SimpleSet, ElementarySet>
>
extends ByteBoundComparisonToolbox<IContinuousByteBound, Set, SimpleSet, ElementarySet, Bridged>
{
	public ContinuousByteBoundComparisonToolbox(final Bridged bridged) {
		super(bridged);
	}

 ...
 */
@NonNullByDefault
public class CommonCompositeByteSetBridge
<
	...
	ChildType extends ICommonByteSet<Bound, Set, SimpleSet, ElementarySet>,
...
extends AbstractSetBridge<Set, SimpleSet, ElementarySet, Bridged>
{
	...
	public CommonCompositeByteSetBridge(final Bridged bridged,
	...
	public List<? extends Set> split(final byte[] values, final boolean[] isIntervalStart) {

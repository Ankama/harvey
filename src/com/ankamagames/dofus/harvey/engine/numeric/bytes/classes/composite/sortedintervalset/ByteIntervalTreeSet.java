 ...
 */
@NonNullByDefault
public class ByteIntervalTreeSet<Interval extends IByteInterval>
implements ISortedByteIntervalSet<Interval>
{
    ...
    public ByteIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public ByteIntervalTreeSet(final ISortedByteIntervalSet<Interval> s) {
    	this();
        addAll(s);
    }
	...
	@Override
	public ISortedByteIntervalSet<Interval> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedByteIntervalSet<Interval> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedByteIntervalSet<Interval> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
 ...
 */
@NonNullByDefault
public class IntIntervalTreeSet<Interval extends IIntInterval>
implements ISortedIntIntervalSet<Interval>
{
    ...
    public IntIntervalTreeSet(final Collection<? extends Interval> c) {
        this();
        addAll(c);
    }

    public IntIntervalTreeSet(final ISortedIntIntervalSet<Interval> s) {
    	this();
        addAll(s);
    }
	...
	@Override
	public ISortedIntIntervalSet<Interval> subSet(@Nullable final Interval fromElement, @Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedIntIntervalSet<Interval> headSet(@Nullable final Interval toElement)
	{
		throw new UnsupportedOperationException();
	}

	@Override
	public ISortedIntIntervalSet<Interval> tailSet(@Nullable final Interval fromElement)
	{
		throw new UnsupportedOperationException();
	}
}
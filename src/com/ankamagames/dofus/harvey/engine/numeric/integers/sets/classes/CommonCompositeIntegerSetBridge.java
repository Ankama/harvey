 ...
 */
@NonNullByDefault
public class CommonCompositeIntegerSetBridge
<
	...
	ChildType extends ICommonIntegerSet<Bound, Set, SimpleSet, ElementarySet>,
...
extends AbstractSetBridge<Set, SimpleSet, ElementarySet, Bridged>
{
	...
	public CommonCompositeIntegerSetBridge(final Bridged bridged,

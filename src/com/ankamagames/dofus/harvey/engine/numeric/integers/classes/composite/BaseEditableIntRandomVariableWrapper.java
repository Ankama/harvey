 ...
 */
@NonNullByDefault
public class BaseEditableIntRandomVariableWrapper
<
	ChildType extends IIntRandomVariable,
	ParentType extends AbstractCompositeIntRandomVariable<?>&IEditableIntRandomVariable,
...
implements IEditableIntRandomVariable
{
	...
	public BaseEditableIntRandomVariableWrapper(final ChildType element, final ParentType parent, final ProbabilityStrategy probabilityStrategy)
	{
		super(element, parent, probabilityStrategy);
		_editor = new BridgedIntRandomVariableWrapperEditor<BaseEditableIntRandomVariableWrapper<ChildType, ParentType, ProbabilityStrategy>>(this);
	}
